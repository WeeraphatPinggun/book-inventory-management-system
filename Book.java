/**
 * คลาส Book
 * ใช้แทนข้อมูลหนังสือ 1 เล่มในระบบจัดการคลังหนังสือ (Book Inventory Management System)
 *
 * เก็บข้อมูล: ชื่อหนังสือ, จำนวนคงเหลือในสต็อก, จำนวนที่ถูกยืมอยู่, ตำแหน่ง/ที่อยู่ของหนังสือ
 */
public class Book {
